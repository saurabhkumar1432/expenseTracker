...
import com.saurabhkumar.expensetracker.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun applyFilter() {
        ...
        val hasActiveFilters = selectedPaymentMethods.isNotEmpty() || selectedCategories.isNotEmpty() || searchQuery.isNotBlank() || (startDate != null && endDate != null)
    ...
    private fun updateFinancialSummary(summary: com.saurabhkumar.expensetracker.data.FinancialSummary) {
    ...
    private fun showFilterDialog() {
        ...
        // Find views
        val recyclerFilterOptions = dialogView.findViewById<androidx.recyclerview.widget.RecyclerView>(
            R.id.recyclerFilterOptions
        )
        val btnClearFilter = dialogView.findViewById<com.google.android.material.button.MaterialButton>(
            R.id.btnClearFilter
        )
        val btnApplyFilter = dialogView.findViewById<com.google.android.material.button.MaterialButton>(
            R.id.btnApplyFilter
        )
        val btnCloseFilter = dialogView.findViewById<com.google.android.material.button.MaterialButton>(
            R.id.btnCloseFilter
        )
        ...
        // Categories
        val recyclerCategoryOptions = dialogView.findViewById<androidx.recyclerview.widget.RecyclerView>(
            R.id.recyclerCategoryOptions
        )
        ...
        val editAmount = dialogView.findViewById<com.google.android.material.textfield.TextInputEditText>(
            R.id.editAmount
        )
        val editReason = dialogView.findViewById<com.google.android.material.textfield.TextInputEditText>(
            R.id.editReason
        )
        ...
        val btnAmount1000 = dialogView.findViewById<com.google.android.material.button.MaterialButton>(
            R.id.btnAmount1000
        )
        ...
        btnSave.setOnClickListener {
            ...
            val reason = editReason.text.toString().trim().ifEmpty { if (selectedType == TransactionType.CREDIT) "Income" else "Expense" }
    ...
    private fun showEditTransactionDialog(transaction: com.saurabhkumar.expensetracker.data.Transaction) {
        val dialogView = layoutInflater.inflate(R.layout.dialog_add_expense, null)
        val modes = Prefs.getModes(this)
        val categories = Prefs.getCategories(this)
        ...
        btnSave.setOnClickListener {
            ...
            // Update transaction
            val updatedTransaction = com.saurabhkumar.expensetracker.data.Transaction(
                id = transaction.id,
                amount = amount,
                reason = reason,
                mode = mode,
    ...
    private fun deleteTransaction(transaction: com.saurabhkumar.expensetracker.data.Transaction) {
    ...
    private fun showDateRangePicker() {
        ...
        val startDatePicker = com.google.android.material.datepicker.MaterialDatePicker.Builder.datePicker()
            ...
            .setSelection(
                startDate ?: com.google.android.material.datepicker.MaterialDatePicker.todayInUtcMilliseconds()
            )
            .build()
        ...
        startDatePicker.addOnPositiveButtonClickListener { startSelection ->
            ...
            val endDatePicker = com.google.android.material.datepicker.MaterialDatePicker.Builder.datePicker()
                ...
                .setSelection(
                    endDate ?: com.google.android.material.datepicker.MaterialDatePicker.todayInUtcMilliseconds()
                )
                .build()
